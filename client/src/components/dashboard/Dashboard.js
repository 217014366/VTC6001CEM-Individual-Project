...
const series = [
  { name: 'Population', key: 'usa', color: '#08abbd' },
  { name: 'Housing', key: 'saudiArabia', color: '#78bc97' },
  { name: 'Health', key: 'iran', color: '#d4d67e' },
  { name: 'Environment', key: 'mexico', color: '#9ccc65' },
  { name: 'Recreation', key: 'russia', color: '#1698af' },
  { name: 'Technology', key: 'consumption', color: consumptionColor, type: AreaSeries },
  { name: 'Education', key: 'price', color: priceColor, scale: 'price', type: SplineSeries },
];
    ...
    return (
      <Paper>
        ...
        >
          ...
          <Title
            text="Livability vs Housing Price"
          />
